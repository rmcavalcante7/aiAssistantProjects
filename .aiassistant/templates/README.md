...
- example context references: [[current-context-example-automation]]
- project bootstrap checklists: [[project-bootstrap-checklist-template]]
- decisions: [[decision-template]]
- checklists: [[checklist-template]]
- feedback entries: [[feedback-template]]
...
- example files in this directory are illustrative only and must never be treated as [[CURRENT_CONTEXT]]
